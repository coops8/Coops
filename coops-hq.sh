...
options=("Update Suite" "Make Version" "Push Release" "View Changelog" "Activate Lockdown" "launch CoopsGPT Terminal Assistant" "Exit")
select opt in "${options[@]}"; do
  case $opt in
    ...
    "Launch CoopsGPT Terminal Assistant")
      bash coops-gpt.sh ;;
    "Exit")
      break ;;
    *) echo "Invalid option" ;;
